...
class UWG(object):
    ...
    def read_input(self):
        ...
        while  count < len(uwg_param_data):
            ...
            if row == [] or "#" in row[0]:
                ...
                self._init_param_dict[row[0]] = [Utilities.str2fl(r[:(len(LADrows[0]) - 1)]) for r in LADrows]
                count += 3
    ...
    def instantiate_input(self):
        ...
        thickness_vector = [0.05 for _ in range(road_layer_num)]
        material_vector = [asphalt for _ in range(road_layer_num)]
    ...
    def simulate(self):
        ...
        for it in range(1,self.simTime.nt,1):# for every simulation time-step defined by uwg
              ...
              if it == Output_TimInd_new[iO_new]:
                  ...
                  qCanyon_hourly[iO_new] = self.BEM[0].building.qcanyon
        ...
        timeseriesFilename = "Output/BEM_hourly.txt" #Output in txt
